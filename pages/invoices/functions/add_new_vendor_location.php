<?php
    ...
    if (mysqli_connect_error()){
        ...
        $res = $conn->query("INSERT INTO vendor_location (vendor_id, address, city, address_notes)
        ...
        } else if ($conn->error == "Duplicate entry '$vendor_id-$new_location' for key 'PRIMARY'"){
